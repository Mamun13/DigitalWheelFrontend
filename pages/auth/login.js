...
const LoginPage = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Login | Digital Wheel</title>
      </Head>
      <section className="login-bg">
        <Container>
          ...
          >
            ...
            >
              <h3 className="font-30 pb-4 font-lato fw-semibold">Sign in</h3>
              ...
              {/* <Form.Group className="mb-3" controlId="">
                  <Form.Label>
                    Refer <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    value={text}
