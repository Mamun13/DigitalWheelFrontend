          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="my-5">
                <ImageSection
                  inventory={inventory}
                  className="img-fluid sec-height"
                />
              </div>
            </div>
            ...
            <div className="col-lg-6 col-md-6 ps-5">
              ...
              <div className="d-flex justify-content-start align-items-center counter mt-3">
                ...
                <div className="d-flex justify-content-between align-items-center border border-secondary rounded-1 counter">
                  <Button
              ...
              <div className="d-flex justify-content-start counter mt-4 mb-4">
                ...
                <div className="ms-2">
                  <button
                    type="button"
                    className="btn btn-success buy-btn rounded-1 text-capitalize px-4 font-lato"
                ...
                <div className="ms-2">
                  <button
                    type="button"
                    className="btn btn-warning buy-btn2 rounded-1 text-capitalize px-4 font-lato"
