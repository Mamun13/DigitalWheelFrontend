...
import CompanyRev from "../../public/vendor.png";
...
const CompanyReview = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>About Us | Digital Wheel</title>
      </Head>
      <section>
              ...
              {mission?.map((item, key) => (
                <div key={key} className="">
                  ...
                  <div className=" mission">
                    <div>
                      <p className="text-justify px-3 pb-5 font-20 text-secondary">
                        {item.item_long_desc}
                      </p>
                    </div>
                  </div>
            ...
            {values?.map((item, key) => (
              ...
              >
                ...
                <div className="col-lg-11 d-flex align-items-center">
                  <p className="font-20 ps-3  text-secondary">
