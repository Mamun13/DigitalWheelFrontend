...
const AddressModal = ({
  ...
  const handleDivisionChange = async (e) => {
    ...
    const fetchDistricts = await fetch(
  ...
  const handleDistrictChange = async (e) => {
    ...
    const fetchUpazilas = await fetch(
            ...
            <Row>
              <Col sm={4}>
                ...
                <Form.Select
                  ...
                  name="division_id"
                  value={
                    selectedDivision ? selectedDivision : myAddress?.division_id
                  }
              ...
              <Col sm={4}>
                ...
                <Form.Select
                  ...
                  name="district_id"
                  value={
                    selectedDistrict ? selectedDistrict : myAddress?.district_id
                  }
              ...
              <Col sm={4}>
                ...
                <Form.Select
                  ...
                  name="upazila_id"
                  value={
                    selectedUpazila ? selectedUpazila : myAddress?.upazila_id
                  }
